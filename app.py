...
diabetes_model = pickle.load(open('D:/multiple disease prediction/diabetes.pkl', 'rb'))
heart_disease_model = pickle.load(open('D:/multiple disease prediction/heart.pkl', 'rb'))
kidney_disease_model = pickle.load(open('D:/multiple disease prediction/kindey.pkl', 'rb'))
NewBMI_Overweight=0
